...
// export const getMovieSwiper: () => Promise<any> = async () => {
//   const result = await (await axios.get('/trending/all/week')).data
//   return result
// }

export const getMovieDetail: (id: string) => Promise<any> = async (id) => {
...
export const getTVDetail: (id: string) => Promise<any> = async (id) => {
  const labels = ['data', 'casts', 'similar', 'videos']
